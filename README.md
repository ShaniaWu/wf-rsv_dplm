...
RSV A&B typing and analysis from Nanopore data. Based on the wf-flu pipeline, modified for RSV. 
...
| blastdb | string | blastdb file used for typing. | If you would like to supply an alternative then provide the full path to the file here. |  |
...
6. Typing using [abricate](https://github.com/tseemann/abricate)

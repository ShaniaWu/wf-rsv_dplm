...
workflow {
    ...
    if (params.blastdb == null){
      ...
      params._blastdb = projectDir.resolve("/data/mounts/project/run-files/rsv/nextclade/blastdb").toString()
    } else {
    ...
    if (params.nextclade_data == null){
      ...
      params._nextclade_data = projectDir.resolve("/data/mounts/project/run-files/rsv/nextclade").toString()
    } else {
      params._nextclade_data = file(params.nextclade_data, type: "directory", checkIfExists:true).toString() 
      params.remove('nextclade_data')
    }
